...
if __name__ == '__main__':
    ...
    parser.add_argument('--llm_model', type=str, help='Path to the llm model', default='./mollama_ckpt/mollama_iter-2220000-ckpt_hf')
    parser.add_argument('--dataset', type=str, help='Path to the llm model', default='QM9-jodo')
